...
Class ProductParsing {
     ...
     */
    static public function call_open_ai($payload, $api_key) {
     ...
     */
    static public function search_part_db($pdo, $producto) {
     ...
     */
    static public function create_embeddings() {
     ...
     */
    static public function parse_product_manual() {
        ...
        $respuesta1 = ProductParsing::call_open_ai($payload1, $api_key);
        ...
        $infoProducto = $productoDetectado ? ProductParsing::search_part_db($pdo, $productoDetectado) : null;
        ...
        if ($infoProducto) {
            ...
            $respuesta2 = ProductParsing::call_open_ai($payload2, $api_key);
     ...
     */
    static public function parse_product_3rd_party() {
     ...
     */
    static public function pase_with_embeddings($mensaje_cliente) {
        ...
        foreach ($productos as $producto) {
            ...
            $score = ProductParsing::cosineSimilarity($consulta_vector, $producto_vector);
        ...
        if ($mejor_producto && isset($mejor_producto[$column_link_part])) {
            ...
            // $contenido = @file_get_contents($mejor_producto[$column_link_part]);

            // if ($contenido) {

            //     $texto_extraido = strip_tags($contenido);
            // }
