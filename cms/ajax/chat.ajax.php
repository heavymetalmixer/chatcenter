...
//####################################################  MODIFIED BLOCK BEGINS  ##########################################################
        ...
        // $url = "messages?linkTo=phone_message,date_created_message&equalTo=".$this->phoneMessage.",".date("Y-m-d")."&startAt=".$this->orderMessage."&endAt=2";
...
//####################################################  MODIFIED BLOCK ENDS  ##########################################################
            ...
            if ($getMessages->total > 1) {
                ...
                if ($getMessages->results[1]->type_message == "client") {
                    ...
                    =============================================*/
                        ...
                        $getMessages->results[1]->client_message = '<a href="'.$archive.'" target="_blank"><img src="'.$archive.'" target="_blank"><img src="/views/assets/img/pdf.jpeg" class="img-fluid rounded"></a><br>'.urldecode(json_decode($getMessages->results[1]->client_message)->caption);
                    }
    ...
    public function ajaxSendMessage() {
        ...
        /*=============================================
        Cuando el negocio envía un video manualmente
        =============================================*/

        else if (end($conversation) == "mp4" ||
                 end($conversation) == "mkv") {
        ...
        =============================================*/
                 ...
                 end($conversation) == "ogg" ||
                 end($conversation) == "aac" ||
                 end($conversation) == "m4a" ||
                 end($conversation) == "wav" ||
                 end($conversation) == "flac" ||
                 end($conversation) == "opus") {
        ...
        /*==============================================
        Cuando el negocio envía un documento manualmente
        ==============================================*/

        else if (end($conversation) == "doc" ||
                 end($conversation) == "docx" ||
                 end($conversation) == "xls" ||
                 end($conversation) == "xlsx" ||
                 end($conversation) == "ppt" ||
                 end($conversation) == "pptx" ||
                 end($conversation) == "pdf" ||
                 end($conversation) == "PDF") {
        ...
        /*=============================================
        Cuando el negocio envía texto manualmente
        =============================================*/
        ...
        if ($getMessages->status == 200) {
            ...
            throw new Exception('$getMessages failed\n');
        }
